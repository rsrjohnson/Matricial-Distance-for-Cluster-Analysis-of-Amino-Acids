...
for l=0:noM-1
    ...
    plot3(Dnew([6+k*l 7+k*l ],1),Dnew([6+k*l 7+k*l ],2),Dnew([6+k*l 7+k*l ],3),'k');
    plot3(Dnew([6+k*l 8+k*l ],1),Dnew([6+k*l 8+k*l ],2),Dnew([6+k*l 8+k*l ],3),'k');
end
